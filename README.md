...
*See* http://hmgaudecker.github.io/econ-project-templates/ *for the full documentation. In particular, read it before continuing with the* **Getting started** *instructions.*
