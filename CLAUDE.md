...
- `bld/`: All computational outputs (auto-generated by pytask)
- `documents/`: Academic paper and presentation (MyST Markdown and Slidev)
- `documents/public/`: Figures included in documents
- `documents/tables/`: Tables included in documents
