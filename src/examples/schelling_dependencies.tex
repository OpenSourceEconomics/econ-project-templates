...
% schelling.py agent.py baseline.json schelling_baseline.pickle
% schelling.py agent.py max_moves_2.json schelling_max_moves_2.pickle
% plot_locations.py baseline.json schelling_baseline.png
% plot_locations.py max_moves_2.json schelling_max_moves_2.png
...
\begin{tikzpicture}[every node/.style={
    ...
    \node (schelling_py) [fill=blue!15, shift={(0, 0)}]
    {
        schelling.py
    };
