...
\begin{tikzpicture}[every node/.style={
    ...
    \node (initial_locations_npy) [shift={(-4, 0)}]
    {
    ...
    \draw[->, orange, thick] (schelling_baseline_pickle) to (initial_locations_npy);
    ...
    \draw[->, orange, thick] (schelling_max_moves_2_pickle) to (initial_locations_npy);
