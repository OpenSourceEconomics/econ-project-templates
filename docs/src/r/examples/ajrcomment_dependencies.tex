...
\begin{tikzpicture}[every node/.style={
    ...
    \draw[->, orange, thick] (first_stage_estimation_baseline_txt) to (ajrcomment_all_dta);
    ...
    \draw[->, orange, thick] (second_stage_estimation_rmconj_txt) to (ajrcomment_all_dta);
    ...
    %final
    \draw[->, teal, thick] (risk_mort_eps) to (ajrcomment_all_txt);
    \draw[->, teal, thick] (gdp_mort_eps) to (ajrcomment_all_txt);
    \draw[->, teal, thick] (risk_mort_eps) to (figure1_mortality_r);
    \draw[->, teal, thick] (gdp_mort_eps) to (figure1_mortality_r);
