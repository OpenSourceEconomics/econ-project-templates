...
\begin{tikzpicture}[every node/.style={
    ...
    \node (ajrcomment_all_txt) [shift={(2.5, 0)}]
    {
        ajrcomment\_all.txt
    };
    ...
    \node (functions_r) [fill=blue!15, shift={(9, 0)}]
    {
        functions.r
    };
    ...
    \node (second_stage_estimation_baseline_txt) [shift={(6, -1)}]
    {
    ...
    \node (second_stage_estimation_baseline_r) [fill=blue!15, shift={(6, -2)}]
    {
        second\_stage\_estimation\_baseline.r
    };


    \node (second_stage_estimation_r) [fill=blue!15, shift={(8, -3)}]
    {
