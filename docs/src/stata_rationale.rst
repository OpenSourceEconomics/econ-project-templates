...
I will not touch upon the last point until the :ref:`stata_organisation` section below. The remainder of this page introduces an example and a general concept of how to think about the first four points.
...
.. figure:: ../bld/stata_example/steps_only_full.png
   :width: 25em
...
.. figure:: ../bld/stata_example/model_steps_full.png
   :width: 25em
...
.. figure:: ../bld/stata_example/model_steps_select.png
   :width: 25em
