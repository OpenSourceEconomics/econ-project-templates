...
.. figure:: ../bld/stata_example/project_hierarchies_big_pic.png
   :width: 50em
...
As an example of how things look further down in the hierarchy, consider the *analysis* step that was described :ref:`here <stata_waf_analysis>`:

.. figure:: ../bld/stata_example/project_hierarchies_analysis.png
   :width: 30em
