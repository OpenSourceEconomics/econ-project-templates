...
.. literalinclude:: python/example_project/wscript
...
.. figure:: ../bld/python_example/schelling_dependencies_data_mgmt.png
   :width: 30em

This is the entire content of the file *src/data_management/wscript*:

.. literalinclude:: python/example_project/src/data_management/wscript
...
.. figure:: ../bld/python_example/schelling_dependencies_main.png
   :width: 40em
...
.. literalinclude:: python/example_project/src/analysis/wscript
...
.. figure:: ../bld/python_example/schelling_dependencies_final.png
   :width: 40em

This step is shown here mostly for completeness, there is nothing really new in the *wscript* file:

.. literalinclude:: python/example_project/src/final/wscript
...
.. figure:: ../bld/python_example/schelling_dependencies_paper.png
   :width: 40em

The corresponding file *src/paper/wscript* is particularly simple:

.. literalinclude:: python/example_project/src/paper/wscript
...
The following figure shows a little bit of how Waf works internally during the build phase:
    ...
    .. figure:: python/waf_build_phase.png
       :width: 30em
