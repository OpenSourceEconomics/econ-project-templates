...
To fix ideas, let's look at the example of Schelling's (1969, :cite:`Schelling1969`) segregation model, as outlined `here <http://quant-econ.net/py/schelling.html>`__ in Stachurski's and Sargent's online course :cite:`StachurskiSargent2019`. Please look at their `description <http://quant-econ.net/py/schelling.html>`__ of the Schelling model. Say we are thinking of two variants for the moment:

    1. Replicate the `figures <http://quant-econ.net/py/schelling.html#results>`__ from Stachurski's and Sargent's course.
