...
.. figure:: ../bld/examples/schelling_dependencies_data_mgmt.png
   :width: 30em

This is the entire content of the file *src/data_management/wscript*:

.. literalinclude:: ../example_python_template/src/data_management/wscript
...
.. figure:: ../bld/examples/schelling_dependencies_main.png
   :width: 40em
...
.. literalinclude:: ../example_python_template/src/analysis/wscript
...
.. figure:: ../bld/examples/schelling_dependencies_final.png
   :width: 40em

This step is shown here mostly for completeness, there is nothing really new in the *wscript* file:

.. literalinclude:: ../example_python_template/src/final/wscript
...
.. figure:: ../bld/examples/schelling_dependencies_paper.png
   :width: 40em
