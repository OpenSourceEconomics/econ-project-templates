...
try:
    ...
    windll.kernel32.FillConsoleOutputCharacterW.argtypes = [
        c_ulong,
        c_wchar,
        c_ulong,
        POINTER(COORD),
    ...
    windll.kernel32.FillConsoleOutputAttribute.argtypes = [
        c_ulong,
        c_ushort,
        c_ulong,
        POINTER(COORD),
    ...
    windll.kernel32.SetConsoleCursorInfo.argtypes = [
        c_ulong,
    ...
    class AnsiTerm:
        ...
        def __init__(self, s):
            ...
            r = windll.kernel32.GetConsoleScreenBufferInfo(
                self.hconsole, byref(self._orig_sbinfo)
            )
            self._isatty = r == 1
...
try:
    ...
    if (sys.stdout.isatty() or sys.stderr.isatty()) and os.environ.get(
        "TERM", ""
    ) not in ("dumb", "emacs"):
