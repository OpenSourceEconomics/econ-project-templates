...
\begin{figure}[H]
    ...
    \centering
    \includegraphics[width=0.85\textwidth]{../figures/smoking_by_marital_status_using_python}
...
\begin{figure}[H]
    ...
    \centering
    \includegraphics[width=0.85\textwidth]{../figures/smoking_by_marital_status_using_r}
