...
\begin{frame}[t]
    \begin{figure}[H]
        ...
        \centering
        \includegraphics[width=0.5\textwidth]{../figures/smoking_by_marital_status_using_python}
...
\begin{frame}[t]
    \begin{figure}[H]
        ...
        \centering
        \includegraphics[width=0.5\textwidth]{../figures/smoking_by_marital_status_using_r}
