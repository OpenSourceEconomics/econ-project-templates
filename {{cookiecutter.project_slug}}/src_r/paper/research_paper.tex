...
{% raw -%}\title{{%- endraw %}{{ cookiecutter.project_name.replace('_', ' ') }}{% raw -%}\thanks{{%- endraw %}{{ cookiecutter.author }}, {{ cookiecutter.affiliation }}. Email: {% raw -%}\href{{%- endraw %}mailto:{{ cookiecutter.email }}}{% raw -%}{\nolinkurl{{%- endraw %}{{ cookiecutter.email.replace('@', ' [at] ').replace('.', ' [dot] ') }}}}.}}
