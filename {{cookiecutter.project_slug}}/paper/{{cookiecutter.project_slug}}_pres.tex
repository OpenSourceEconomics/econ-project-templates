...
\begin{frame}[t]
    \begin{figure}[H]
        ...
        \centering
        \includegraphics[width=0.5\textwidth]{../python/figures/marital_status-figure}
...
\begin{frame}[t]
    \begin{figure}[H]
        ...
        \centering
        \includegraphics[width=0.5\textwidth]{../r/figures/marital_status-figure}

        \caption{\emph{R:} Model predictions of the smoking probability over the
        lifetime. Each colored line represents a case where marital status is fixed to
        one of the values present in the data set.}
