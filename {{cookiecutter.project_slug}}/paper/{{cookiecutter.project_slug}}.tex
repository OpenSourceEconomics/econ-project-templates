...
\begin{figure}[H]
    ...
    \centering
    \includegraphics[width=0.85\textwidth]{../python/figures/marital_status-figure}
...
\begin{table}[!h]
    \input{../python/tables/estimation_table.tex}
...
\begin{figure}[H]
    ...
    \centering
    \includegraphics[width=0.85\textwidth]{../r/figures/marital_status-figure}
...
\input{../r/tables/estimation_table.tex}
    \begin{center}
